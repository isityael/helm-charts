...
- Feat(csi-driver-nfs): switch nfsplugin to ghcr.io/isityael/nfsplugin

Custom-built image from isityael/csi-driver-nfs fork with CSI spec
...
ghcr.io/isityael/wakapi:2.17.2-patched.
...
Image builds moved to the isityael/wakapi fork repo. The Dockerfile
...
Sync with rebased isityael/csi-driver-nfs fork (now 7 commits ahead
...
all charts to oci://ghcr.io/isityael/charts. Skips versions that
already exist on GHCR.

Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com>
- Feat(ci): add publish-all pipeline for GHCR OCI chart releases

Packages and pushes all charts to oci://ghcr.io/isityael/charts on
...
# [1.1.0](https://github.com/isityael/helm-charts/compare/cloudflared-v1.0.0...cloudflared-v1.1.0) (2026-03-24)

### Features

* **csi-driver-nfs:** add forked chart with configurable fsGroupPolicy ([659c2f9](https://github.com/isityael/helm-charts/commit/659c2f9ef9404d0c12d3cf711f4bcd307dabd0b7))
- Chore(release): cloudflared 1.2.0 [skip ci]

# [1.2.0](https://github.com/isityael/helm-charts/compare/cloudflared-v1.1.0...cloudflared-v1.2.0) (2026-03-30)

### Features

* **csi-driver-nfs:** bump sidecars to upstream master, migrate to DHI ([256fabe](https://github.com/isityael/helm-charts/commit/256fabeba3970ddef434580fa33510397b8ac715))
- Chore(release): cloudflared 1.3.0 [skip ci]

# [1.3.0](https://github.com/isityael/helm-charts/compare/cloudflared-v1.2.0...cloudflared-v1.3.0) (2026-03-30)

### Features

* **ci:** push charts to GHCR OCI on release ([2bad482](https://github.com/isityael/helm-charts/commit/2bad482b3e9596b79742c8850d851995da896e27))
...
Port the csi-driver-nfs chart from the isityael fork (based on upstream
...
ghcr.io/isityael/charts on csi-driver-nfs-v* tags.
...
* **ci:** add helm dependency build before linting ([576d16e](https://github.com/isityael/helm-charts/commit/576d16e59e0fe3be9568818338c444d9d4bec8ba))

### Features

* **cloudflared:** fork community chart with rolling update fixes ([3dd9d88](https://github.com/isityael/helm-charts/commit/3dd9d88df44031cdbc2ac6356c83f4ac7b2d2267))
...
for automated OCI chart publishing to ghcr.io/isityael/charts, npm
...
- Merge pull request #17 from isityael/renovate/major-github-actions
...
- Initial plan
- Merge pull request #7 from isityael/copilot/update-helm-charts-dependencies

chore(deps): update releaseargus/argus to v0.29.1
- Merge branch 'main' into renovate/patch-helm-charts
- Merge pull request #8 from isityael/renovate/patch-helm-charts
- Merge pull request #9 from isityael/renovate/patch-helm-charts
...
- Merge pull request #5 from isityael/renovate/major-github-actions
- Merge pull request #6 from isityael/renovate/github-actions
- Bump gitea-runner
...
Co-authored-by: isityael <12695314+isityael@users.noreply.github.com>
- Merge pull request #3 from isityael/copilot/fix-renovate-configuration-error
...
- Merge pull request #1 from isityael/copilot/add-helm-charts-for-deployment
