...
{{- $tag := regexReplaceAll "@.*$" (.Values.postgres.image.tag | default "") "" -}}
{{- if $tag -}}
{{- printf "%s:%s@%s" .Values.postgres.image.repository $tag .Values.postgres.image.digest -}}
{{- else -}}
...
{{- $tag := regexReplaceAll "@.*$" (.Values.redis.image.tag | default "") "" -}}
{{- if $tag -}}
{{- printf "%s:%s@%s" .Values.redis.image.repository $tag .Values.redis.image.digest -}}
{{- else -}}
...
{{- if .Values.waitForRedis.image.digest -}}
{{- $tag := regexReplaceAll "@.*$" (.Values.waitForRedis.image.tag | default "") "" -}}
{{- if $tag -}}
{{- printf "%s:%s@%s" .Values.waitForRedis.image.repository $tag .Values.waitForRedis.image.digest -}}
{{- else -}}
{{- printf "%s@%s" .Values.waitForRedis.image.repository .Values.waitForRedis.image.digest -}}
{{- end -}}
{{- else -}}
