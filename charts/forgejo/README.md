...
- custom `ghcr.io/isityael/forgejo` image support without the upstream `-rootless` tag suffix issue
...
runner:
  ...
  runner:
    ...
    labels: docker:docker://ghcr.io/isityael/forgejo-job-alpine:3.23
```
